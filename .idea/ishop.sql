...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Сен 21 2018 г., 22:15
...
CREATE TABLE `brand` (
  ...
  `arm_description` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `brand` (`id`, `en_title`, `ru_title`, `arm_title`, `alias`, `img`, `en_description`, `ru_description`, `arm_description`) VALUES
(1, 'Casio', 'Касио', 'Կասիո', 'casio', 'abt-1.jpg', 'In sit amet sapien eros Integer dolore magna aliqua', 'Русское описание', 'Հայերեն նկարագրություն'),
(2, 'Citizen', 'Ситизен', 'Սիթիզեն', 'citizen', 'abt-2.jpg', 'In sit amet sapien eros Integer dolore magna aliqua', 'Русское описание', 'Հայերեն նկարագրություն'),
(3, 'Royal London', 'Ройал Лондон', 'Ռոյալ Լոնդոն', 'royal-london', 'abt-3.jpg', 'In sit amet sapien eros Integer dolore magna aliqua', 'Русское описание', 'Հայերեն նկարագրություն'),
(4, 'Seiko', 'Сейкио', 'Սեյկիո', 'seiko', 'seiko.png', NULL, 'Русское описание', 'Հայերեն նկարագրություն'),
(5, 'Diesel', 'Дизел', 'Դիզել', 'diesel', 'diesel.png', NULL, '', 'Հայերեն նկարագրություն');

-- --------------------------------------------------------

--
-- Структура таблицы `brand1`
--
...
--
-- Дамп данных таблицы `brand1`
--

INSERT INTO `brand1` (`id`, `title`, `alias`, `img`, `description`) VALUES
...
(9, 6, 4, 'Royal London 20034-02', 'royal-london-20034-02', NULL, 110, 0, '1', NULL, NULL, 'no_image.png', '0'),
(10, 6, 4, 'Royal London 41156-02', 'royal-london-41156-02', '<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam tristique, diam in consequat iaculis, est purus iaculis mauris, imperdiet facilisis ante ligula at nulla. Quisque volutpat nulla risus, id maximus ex aliquet ut. Suspendisse potenti. Nulla varius lectus id turpis dignissim porta. Quisque magna arcu, blandit quis felis vehicula, feugiat gravida diam. Nullam nec turpis ligula. Aliquam quis blandit elit, ac sodales nisl. Aliquam eget dolor eget elit malesuada aliquet. In varius lorem lorem, semper bibendum lectus lobortis ac.</p>\n\n                                            <p>Mauris placerat vitae lorem gravida viverra. Mauris in fringilla ex. Nulla facilisi. Etiam scelerisque tincidunt quam facilisis lobortis. In malesuada pulvinar neque a consectetur. Nunc aliquam gravida purus, non malesuada sem accumsan in. Morbi vel sodales libero.</p>', 100, 0, '1', NULL, NULL, 'no_image.png', '1'),
...
--
-- AUTO_INCREMENT для таблицы `brand1`
--
ALTER TABLE `brand1`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
