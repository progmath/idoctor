        ...
        <div class="single-main">
            ...
            <div class="col-md-9 single-main-left">
                <div class="sngl-top">
                    ...
                    <?php
                        $curr = \PM_Engine\App::$app->getProperty('currency');/*debug($curr);*/
                    ...
                    <div class="col-md-7 single-top-right">
                        <div class="single-para simpleCart_shelfItem">
                            <h2><?= $product->title;?><!--Lorem Ipsum--></h2>
                            <div class="star-on">
                            ...
                            <h5 class="item_price" id="base-price" data-base="<?=$product->price * $curr['value']; ?>"><?=$curr['symbol_left']; ?> <?=$product->price * $curr['value']; ?><?=$curr['symbol_right']; ?><!--$ 95.00--></h5>
                            <?php if ($product->old_price):?>
                                <del id="base-old-price" data-base="<?=$product->old_price * $curr['value']; ?>"><?=$curr['symbol_left'];?><?=$product->old_price * $curr['value']; ?><?=$curr['symbol_right'] ?></del>
                            <?else:?>
                                <del id="base-old-price" data-base="<?=$product->old_price * $curr['value']; ?>"></del>
                            <?php endif; ?>
                            ...
                            <a id="productAdd" data-id="<?=$product->id?>" href="cart/add?id=<?=$product->id?>" class="add-cart add-to-cart-link item_add">ADD TO CART</a>
                ...
                <div class="latestproducts">
                    <div class="product-one">
                        <h2 style="text-align: center;margin-bottom: 55px;color:red;">Recomendet Products:</h2>
                ...
                <?php if($recentlyViewed):?>
                    <div class="latestproducts">
                        <div class="product-one">
                            ...
                            <?php  endforeach; ?>
                            <div style="text-align: center;"><a style="color:blue;" href="recently/all" >View More</a></div>
