...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                <form action="<?=ADMIN;?>/diagnose/add" method="post" data-toggle="validator">
                    <div class="box-body">
                        <div class="form-group has-feedback">
                            <label for="arm_title"><?= $lang[$code . '_' . "Diagnose Name"] .$lang[$code . '_' . "Armenian"];?>* </label>
                            <input type="text"  name="arm_title" class="form-control" id="arm_title" placeholder="<?= $lang[$code . '_' . "Diagnose Name"] .$lang[$code . '_' . "Armenian"];?> *" value="<?= isset($_SESSION['form_data']['arm_title']) ? h($_SESSION['form_data']['arm_title']) : null; ?>" required>
                            <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                        </div>

                        <div class="form-group">
                            <label for="ru_title"><?= $lang[$code . '_' . "Diagnose Name"] .$lang[$code . '_' . "Russian"];?></label>
                            <input type="text" name="ru_title" class="form-control" id="ru_title" placeholder="<?= $lang[$code . '_' . "Diagnose Name"] .$lang[$code . '_' . "Russian"];?>" value="<?= isset($_SESSION['form_data']['ru_title']) ? h($_SESSION['form_data']['ru_title']) : null; ?>" >
                        </div>
                        <div class="form-group">
                            <label for="en_title"><?= $lang[$code . '_' . "Diagnose Name"] .$lang[$code . '_' . "English"];?></label>
                            <input type="text" name="en_title" class="form-control" id="en_title" placeholder="<?= $lang[$code . '_' . "Diagnose Name"] .$lang[$code . '_' . "English"];?>" value="<?= isset($_SESSION['form_data']['en_title']) ? h($_SESSION['form_data']['en_title']) : null; ?>" >
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group has-feedback">
                            <label for="min_price" ><?= $lang[$code . '_' . "Min Price"]?></label>
                            <input type="text" name="min_price" pattern="^[0-9.]{1,}$"  id="min_price"  class="form-control" value="<?= isset($_SESSION['form_data']['min_price']) ? h($_SESSION['form_data']['min_price']) : null; ?>" >
                            <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                        </div>

                        <div class="form-group has-feedback">
                            <label for="max_price" ><?= $lang[$code . '_' . "Max Price"]?></label>
                            <input type="text" name="max_price" pattern="^[0-9.]{1,}$"  id="max_price"  class="form-control" value="<?= isset($_SESSION['form_data']['max_price']) ? h($_SESSION['form_data']['max_price']) : null; ?>" >
                            <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                        </div>
                        ...
                        <div class="form-group">
                            <label>
                                <input type="checkbox" name="hit" <?= isset($_SESSION['form_data']['hit']) && $_SESSION['form_data']['hit'] ? "checked" : null; ?>> <?= $lang[$code . '_' . "Hit"]?>
                            </label>
                        </div>
                        <div class="form-group">
                            <label>
                                <input type="checkbox" name="screening" <?= isset($_SESSION['form_data']['screening']) && $_SESSION['form_data']['screening'] ? "checked" : null; ?> id="screening"> <?= $lang[$code . '_' . "Screening"]?>
                            </label>
                        </div>
 ...
 -->
                                   <select name="min_age" id="min_age">
                                       <?if(isset($_SESSION['form_data']['min_age'])):?>
                                           <option value="<?= $_SESSION['form_data']['min_age']?>" selected><?= $_SESSION['form_data']['min_age']?></option>
                                       <?endif;?>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="max_age" id="max_age">
                                        <?if(isset($_SESSION['form_data']['max_age'])):?>
                                            <option value="<?= $_SESSION['form_data']['max_age']?>" selected><?= $_SESSION['form_data']['max_age']?></option>
                                        <?endif;?>
                                        <option value="1">1</option>
                                        <option value="2">2</option>
                                        <option value="3">3</option>
                                ...
                                <div class="form-group ">
                                    <label for="gender"><?= $lang[$code . '_' . "Gender"]?></label>
                                    <input type="checkbox" name="male" <?= isset($_SESSION['form_data']['male']) && $_SESSION['form_data']['male']? "checked" : null; ?>><?= $lang[$code . '_' . "Male"]?>
                                    <input type="checkbox" name="female" id="screening_female" <?= isset($_SESSION['form_data']['female'])&& $_SESSION['form_data']['female'] ? "checked" : null; ?>><?= $lang[$code . '_' . "Female"]?>
                                </div>
                                <div class="form-group" id="pregnant">
                                    <label for="female_type"><?= $lang[$code . '_' . "Female Status"]?></label>
                                    <input type="checkbox" name="pregnant" <?= isset($_SESSION['form_data']['pregnant']) && $_SESSION['form_data']['pregnant']? "checked" : null; ?>><?= $lang[$code . '_' . "Pregnant"]?>
                                    <input type="checkbox" name="not_pregnant" <?= isset($_SESSION['form_data']['not_pregnant']) && $_SESSION['form_data']['not_pregnant'] ? "checked" : null; ?>><?= $lang[$code . '_' . "Not Pregnant"]?>
                                </div>
                                <div class="form-group ">
                                    <label for="smoke"><?= $lang[$code . '_' . "Smoke"]?></label>
                                    <input type="checkbox" name="smoking" <?= isset($_SESSION['form_data']['smoking']) && $_SESSION['form_data']['smoking'] ? "checked" : null; ?>><?= $lang[$code . '_' . "Smoking"]?>
                                    <input type="checkbox" name="not_smoking" <?= isset($_SESSION['form_data']['not_smoking']) && $_SESSION['form_data']['not_smoking'] ? "checked" : null; ?>><?= $lang[$code . '_' . "Not Smoking"]?>
                                </div>
                                <div class="form-group ">
                                    <label for="activity"><?= $lang[$code . '_' . "Sexual Activity"]?></label>
                                    <input type="checkbox" name="regular" <?= isset($_SESSION['form_data']['regualr']) && $_SESSION['form_data']['regular'] ? "checked" : null; ?>><?= $lang[$code . '_' . "Regular"]?>
                                    <input type="checkbox" name="not_regular" <?= isset($_SESSION['form_data']['not_regular']) && $_SESSION['form_data']['not_regular'] ? "checked" : null; ?>><?= $lang[$code . '_' . "Not Regular"]?>
                                </div>
                            </div>
                        </div>
                        <div class="form-group ">
